...
class ExpenseService:
    ...
    def process_expense(self, message: str, user: User) -> Tuple[bool, str, Expense | None]:
        """
        ...
        """
        is_valid, reply, data = PriceProcessorService.process_message(message)
        ...
        try:
            ...
            self.logger.error(f"Error with Google Sheets service: {str(e)}")
